  ...
  return (
    <section ref={sectionRef} className="py-20 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-6xl mx-auto">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'animate-slideInUp opacity-100' : 'opacity-0'}`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            About <span className="gradient-text">Me</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            I'm a passionate fullstack developer who loves turning ideas into reality through code.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'animate-slideInLeft opacity-100' : 'opacity-0'}`}>
            <div className="relative">
              <div className="glass p-8 rounded-2xl">
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-bold mb-2 text-white">Merabet Abdelkarim</h3>
                  <p className="text-blue-400 font-semibold">Fullstack Developer</p>
                </div>
              </div>
            </div>
          </div>

          <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'animate-slideInRight opacity-100' : 'opacity-0'}`}>
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                With expertise in modern web technologies, I specialize in creating 
                seamless user experiences and robust backend solutions. My passion lies in 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="glass p-6 rounded-xl hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-gray-300 text-sm">
                    React, Next.js, TypeScript, Tailwind CSS, and modern UI libraries
                  </p>
                </div>
