...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Cross-platform social media app built with React Native. Real-time messaging, photo sharing, and social features.',
    ...
    },
    {
      ...
      description: 'Collaborative project management platform with real-time updates, task tracking, and team collaboration features.',
    ...
    },
    {
      ...
      description: 'Beautiful weather application with detailed forecasts, interactive maps, and location-based weather data.',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className={`glass rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-500 group ${
                ...
                <div className={`grid ${project.featured ? 'lg:grid-cols-2' : 'md:grid-cols-3'} gap-0`}>
                  ...
                  <div className={`p-8 ${project.featured ? 'lg:order-2' : 'md:col-span-2'} flex flex-col justify-center`}>
